...
#sudo podman exec -it mosquitto1 sshpass -p "password" rsync -avz --stats -e "ssh -o StrictHostKeyChecking=no" /mosquitto/mosquitto.db root@192.168.5.11:/mosquitto/mosquitto.db
